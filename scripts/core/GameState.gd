...
var last_refresh_total_ms: float = 0.0
var last_refresh_enemy_preview_ms: float = 0.0
var last_refresh_sync_views_ms: float = 0.0
var last_refresh_music_ms: float = 0.0
var last_refresh_board_render_ms: float = 0.0
var last_refresh_hud_ms: float = 0.0
...
var focused_nav_target_cell: Vector2i = Vector2i(-1, -1)
var focused_nav_target_label: String = ""
